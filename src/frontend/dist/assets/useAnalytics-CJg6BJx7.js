import { a as clsx } from "./skeleton-MV_wEVED.js";
import { b as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, R as React, i as invariant, d as useQuery, f as useActor, h as createActor } from "./index-b-kEL4Ku.js";
...
function useAppointmentTrend(days = BigInt(30)) {
  const { actor, isFetching } = useBackendActor();
  return useQuery({
...
export {
  ...
  XAxis as X,
  YAxis as Y,
  useAppointmentTrend as a,
  Line as b,
  Bar as c,
  Legend as d,
  useAppointmentStats as u
};
